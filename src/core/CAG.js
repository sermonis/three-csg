import { Connector, fromPolygons, fromSides, fromFakeCSG } from 'core';
import { Vertex, Vector2D, Vector, Polygon } from 'math';
import { canonicalize, reTessellate, isCAGValid, isSelfIntersecting, hasPointInside, area, getBounds } from 'utils';
import {
    ...
    contract,
    expandedShellOfCAG,
} from 'api'; // all of these are good candidates for elimination in this scope, since they are part of a functional api
