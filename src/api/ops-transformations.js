import { Matrix4x4, Plane, Vector } from 'math';
import { union } from 'api';
import { fromPoints } from 'core';
import { CONSTANTS, isCAG } from 'utils';
...
function mirror(vector, ...objects) {
    ...
    const plane = new Plane(new Vector(vector[0], vector[1], vector[2]).unit(), 0);
...
export { translate, center, scale, rotate, transform, mirror, minkowski, hull, chain_hull };
