import { parseOptionAs2DVector, parseOptionAsFloat, parseOptionAsInt } from 'api';
import { CAG, defaultResolution2D, fromCompactBinary, fromPoints, fromPath2, fromSides } from 'core';
import { Path2D, Vector2D } from 'math';
